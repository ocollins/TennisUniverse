...
create table IF NOT EXISTS TENNIS_UNIVERSE.PERSON (
  ...
  REFERENCES TENNIS_UNIVERSE.USER_ROLE(USER_ROLE_ID)
    ON DELETE CASCADE,
...
INSERT INTO TENNIS_UNIVERSE.PERSON VALUES (108, 999999999, "DEB", "JOHNSON", "1945-03-04", 01, "DJOHNSON@TDS.COM", "1 MAIN ST","" , "MADISON", "WI", "53555", "6083456868", CURRENT_TIMESTAMP);
