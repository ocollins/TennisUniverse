...
<div id="container2">
    ...
    <div class="info_div">
        <p id="club_info_p">Whether you are new to tennis, getting back into the game or a seasoned competitor, <br />
    ...
    <div class="info_div">
        ...
        <p>Lessons can be booked with our staff of world class tennis professionals by calling them directly</p>
        <ul>
